...
class GUIManager:
    def __init__(self, twitch: Twitch):
        ...
        self._root = root = Tk(className=twitch.modified_window_title) # modified by Hitokage
        ...
        root.title(twitch.modified_window_title)  # modified by Hitokage new window title
